...
function ExpandedPanel({
  ...
  return (
    <div className="flex h-full flex-shrink-0 flex-col gap-2 border-r border-border-light bg-surface-primary-alt px-2 py-2 shadow-[1px_0_0_rgba(15,54,64,0.03)]">
      <TooltipAnchor
        side="right"
        ...
        render={
          <Button
            ...
            className="h-9 w-9 rounded-lg border border-border-light bg-surface-primary shadow-sm transition-all hover:border-border-medium hover:bg-surface-hover"
            onClick={toggleClick}
          >
            <img
